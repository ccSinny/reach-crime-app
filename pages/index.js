...
export default function crimeApp() {
  ...
  useEffect(() => {
    if (userLatitude && userLongitude) {
      fetch(
        `https://data.police.uk/api/stops-street?lat=${userLatitude}&lng=${userLongitude}&date=${convertDateToFetchFormat(startDate)}`
      )
        .then((r) => r.json())
  ...
  return (
    <div>
      ...
      />
      <Text>Please mark your location on the map and click the blue dot to see more information on the potential crime</Text>
      ...
      <MyMapComponent
        ...
        containerElement={<div style={{ height: `600px`, maxHeight: `80vh` }} />}
